...
@Component({
  selector: 'app-quiz-show-list',
  templateUrl: './quiz-show-list.component.html',
  styleUrls: ['./quiz-show-list.component.css']
})
export class QuizShowListComponent implements OnInit {
